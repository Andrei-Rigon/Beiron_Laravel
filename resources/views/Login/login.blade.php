...
<body onload="fadeIn()">
  <div class="conteiner">
    <form class="form" action="{{ route('login-store') }}" method="POST">@csrf
      <div class="titulo">
      ...
      <div class="box1">
        <input class="box-text" type="text" name="LOGIN" id="nome" required placeholder="Usuário" maxlength="25"  value={{ old("LOGIN") }} ><br>
