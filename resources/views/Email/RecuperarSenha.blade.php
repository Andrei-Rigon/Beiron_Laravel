...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/email/Recriar_senha.css') }}">
    <link
        rel="stylesheet"
...
<body onload="fadeIn()">
    ...
    <img class="img-backgrund" src="{{ asset('assets/paisagem-magenta-da-fantasia-da-natureza.jpg') }}" alt="img">
    <script src="{{ asset('js/email/Recriar_senha.js') }}"></script>
</body> 
