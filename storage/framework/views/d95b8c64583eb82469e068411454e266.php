...
<body onload="fadeIn()">
    <div class="conteiner">
        ...
        <form class="conteiner1" action="<?php echo e(route('email-store')); ?>" method="POST" ><?php echo csrf_field(); ?>
            <div class="text1">
                <input class="box-text" type="text" name="usuario" required
                     placeholder="Login"
                    maxlength="25" value="<?php echo e(old('usuario')); ?>" > <br>
                <input class="box-text" type="text" name="email" required
                    placeholder="E-mail"
                    maxlength="40" value="<?php echo e(old('email')); ?>"><br>
            </div>
            <div class="pbotao">
                <button class="botao" type="submit" name="send">Enviar</button>
            </div>
            <a class="voltarLogin" href="<?php echo e(route('login-index')); ?>">Voltar para o login</a>
...
<?php endif; ?>            
    ...
    <img class="img" src="<?php echo e(asset('assets/paisagem-de-formacoes-rochosas-naturais.jpg')); ?>" alt="img">

    <script src="<?php echo e(asset('js/email/email.js')); ?>" ></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\Beiron_Laravel\resources\views/Email/email.blade.php ENDPATH**/ ?>